          ...
          <section className="bg-white w-full dark:bg-gray-900">
            <div className="container flex items-center justify-center  px-6 mx-auto">
              <form className="w-full max-w-md">
                ...
                <div className="mt-6">
                  <button className="w-fit px-6 py-3 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-[#1EB7D8] rounded-md hover:bg-[#1eb6d8b7] focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-50">
                    Sign in
                  </button>
